...
public class CheckingAccountScreen extends JPanel {
	...
	public JPanel init() {
		...
		try {
			auxRandomAccount = productoService.generateAccountNumber();
		...
		submitButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					productoService.create(randomAccountNumber, "CA", PanelManager.selectedUser.getID(),
